...
setwd("~/Uni/visuell/imagequalityseminar/code/output/1/LB/")
...
for (i in 0:2){
	...
	if(i==1){# condition rain 
		...
		d3 <- read.csv('design_LB_triads_2_results_rain.csv')
		}
	...
	if(i==2){#  condition no rain
		...
		d3 <- read.csv('design_LB_triads_2_results_norain.csv')
		}
