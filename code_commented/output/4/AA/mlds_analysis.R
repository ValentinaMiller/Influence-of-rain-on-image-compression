...
setwd("/Users/dr.ernsthaft/Desktop/imagequalityseminar-v2/code/output/4/AA")
...
for (i in 0:2){
	...
	if(i==0){# condition artificial rain 
		d1 <- read.csv('design_AA_triads_0_results_art_rain.csv')
		d2 <- read.csv('design_AA_triads_1_results_art_rain.csv')
		d3 <- read.csv('design_AA_triads_2_results_art_rain.csv')
		}
	...
	if(i==1){# condition rain 
		d1 <- read.csv('design_AA_triads_0_results_rain.csv')
		d2 <- read.csv('design_AA_triads_1_results_rain.csv')
		d3 <- read.csv('design_AA_triads_2_results_rain.csv')
		}

	if(i==2){#  condition no rain
		d1 <- read.csv('design_AA_triads_0_results_norain.csv')
		d2 <- read.csv('design_AA_triads_1_results_norain.csv')
		d3 <- read.csv('design_AA_triads_2_results_norain.csv')
		}
